...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="My_Ads/my_ads_style.css">
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
    <link rel="shortcut icon" href="My_Ads/icon.png" type="image/x-icon" />
    <title>My Ads-Restoke</title>
</head>
<body>
...
<div class="menu">
    <ul class="menu_ul">
        ...
        <li><a href="/restoke_war/my_ads" style="background: #2f3640">My Ads</a></li>
...
<script src="My_Ads/my_ads_scripts.js"></script>
</body>
</html>