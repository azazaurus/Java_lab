...
<head>
    ...
    <link rel="stylesheet" href="Searching_Page/searching_page.css">
    <link rel="shortcut icon" href="../Searching_Page/icon.png" type="image/x-icon" />
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
    <title>Search Page-Restoke</title>
</head>
<body>
    ...
    <div class="filters">
        ...
        <form method="get">
            ...
            <div class="price_filter">
                <div class="min_price">
                    <input type="text" id="text" name="min_price" value="" placeholder="Min price"/>
                </div>
                <div class="max_price">
                    <input type="text" id="text" name="max_price" value="" placeholder="Max price"/>
                </div>
            </div>
...
<div class="tape" style="letter-spacing: 5px; color: #2f3640; text-align: center;">Searching page</div>
...
<script src="Searching_Page/searching_page.js"></script>
</body>
</html>